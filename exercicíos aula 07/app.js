...
let sentencearrumada = '';

for (let palavra of sentence) {
  if (palavra !== 'certeza') {
    sentencearrumada += palavra + ' ';
  }
}

console.log(sentencearrumada);
/*
  05
...
/// essas eu realmente não consigo entender
/*
  06
