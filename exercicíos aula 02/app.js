...
let strHomemAranha = (`Grandes poderes trazem grandes responsabilidades.`)
console.log(strHomemAranha);
...
console.log(`o meu é o ${myFavoriteTom}`)
...
console.log("Tamanho da string:", pL.length);
...
let ultimonumero = randomWord[randomWord.length - 1];
...
const winterMessage = 'winterMessage'
...
const allEpisodes = `NUMERO_DE_EPISÓDIOS`;
allEpisodes = allEpisodes.replace("NUMERO_DE_EPISÓDIO", episodes);
