...
const sentencenova = `Minhas 3 séries favoritas são : ${my3FavoriteTVShows[0]},${my3FavoriteTVShows[1]} e ${my3FavoriteTVShows[2]}.`;

console.log (`Minhas 3 séries favoritas são ${sentencenova}`)
