...
const foodsInfo = 'Até aqui, o arraz \"brazilianFoods\" possui NUMERO_DE_ITENS'
    'itens: NOME_DO_ITEM_1, NOME_DO_ITEM_2, NOME_DO_ITEM_3.'
...
dogNames.pop(dogNames[dogNames.lenght - 1])
//console.log(dogNames[dogNames.length - 1])
